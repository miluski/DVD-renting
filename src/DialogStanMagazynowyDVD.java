/** @file DialogStanMagazynowyDVD.java
 * @brief plik zawierający kod dialog boxa pozwalajacego na przeglądanie stanu magazynowego DVD od strony administratora wypożyczalnii
 * @author Jakub Szczur
