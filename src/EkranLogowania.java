...
public class EkranLogowania extends javax.swing.JFrame {
    protected static String login_uzytkownika;
    protected static String haslo_uzytkownika;
    protected static String wiadomosc, ranga;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        if(jTextField1.getText().isEmpty() || jPasswordField1.getPassword().length == 0){
            ...
            haslo_uzytkownika = Klient.hashPassword(new String(jPasswordField1.getPassword()),"e5WX^6&dNg8K");
            try {
                Klient.polacz();
                Klient.zaloguj();
