/** @file DialogPrzegladajListeKlientow.java
 * @brief plik zawierający kod dialog boxa pozwalajacego na przeglądanie listy klientów od strony administratora wypożyczalnii
 * @author Jakub Szczur
