/** @file DialogPrzegladajWypozyczenia.java
 * @brief plik zawierający kod dialog boxa pozwalajacego na przeglądanie wypożyczeń od strony administratora wypożyczalnii
 * @author Jakub Szczur
