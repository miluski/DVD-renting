...
public class UnitTests {
    ...
    public void testSetIP() {
        EkranSerwer serwer = new EkranSerwer();
        String expectedIP = "192.168.0.1";

        serwer.setIP(expectedIP);
        String actualIP = serwer.IP;
    ...
    public void testSetMessage() {
        ...
        serwer.setMessage(initialText);
        serwer.setMessage(message);
