...
public class DialogUsunDVD extends javax.swing.JDialog {
    ...
    /**
     * Creates new form DialogUsunDVD
     */
    public DialogUsunDVD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogUsunDVD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogUsunDVD dialog = new DialogUsunDVD(new javax.swing.JFrame(), true);
