/** @file DialogUtworzTabele.java
 * @brief plik zawierający kod dialog boxa pozwalajacego na utworzenie wybranej tabeli od strony administratora wypożyczalnii
 * @author Jakub Szczur
...
public class DialogUtworzTabele extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Wypożyczalnia DVD - Utwórz tabele");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setFont(new java.awt.Font("Segoe UI", Font.PLAIN, 18));
        jLabel1.setText("Utwórz tabele");

        jLabel2.setFont(new java.awt.Font("Segoe UI", Font.BOLD, 14));
        jLabel2.setText("Wybierz tabelę z listy");
        jLabel2.setToolTipText("");

        //TODO: Dodawanie tworzonych tabel do listy
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"CREATE TABLE users", "CREATE TABLE users_data", "CREATE TABLE dvds_data","CREATE TABLE rents", "CREATE TABLE returns", "CREATE TABLE bills", "CREATE TABLE reservations"}));
