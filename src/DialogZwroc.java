...
public class DialogZwroc extends javax.swing.JDialog {
    ...
    /**
     * Creates new form DialogZwroc
     */
    public DialogZwroc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Wybierz z listy DVD, które klient chce zwrócić");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel3.setText("Wybierz z listy Klienta, który DVD zwraca");
        ...
        jTextArea1.setText("KlientKlientKlientKlientKlientKlientKlientKlient");
        jTextArea1.setPreferredSize(new java.awt.Dimension(232, 25));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DialogZwroc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DialogZwroc dialog = new DialogZwroc(new javax.swing.JFrame(), true);
