 ...
 * @brief plik zawierający kod dialog boxa pozwalajacego na zwrócenie wybranej płyty DVD od strony administratora wypożyczalnii
 * @author Jakub Szczur
...
public class DialogZwroc extends javax.swing.JDialog {
    ...
    protected static String userID, rentID, filmName;
    private static int numberOfCopies, dvdID;
