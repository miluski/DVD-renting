 ...
 * @brief plik zawierający kod dialog boxa pozwalajacego na wypożyczenie płyty DVD dla klienta od strony administratora wypożyczalnii
 * @author Jakub Szczur
...
public class DialogWypozycz extends javax.swing.JDialog {
    ...
    protected static String userID,dvdID,numberOfCopies;
